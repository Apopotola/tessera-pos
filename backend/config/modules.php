...
return [
    ...
    */
    'stubs' => [
        ...
        'files' => [
            // API-only modules: no Blade views, Vite or asset stubs.
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'tessera'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'SoftClans'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'dev@softclans.co.ke'),
        ],
